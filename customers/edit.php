...
<form action="edit.php?id=<?php echo $customer['id']; ?>" method="post">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" maxlength="11" name="customer['cpf_cnpj']" value="<?php echo $customer['cpf_cnpj']; ?>">
    </div>
  ...
  <div class="row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control"  maxlength="8" name="customer['zip_code']" value="<?php echo $customer['zip_code']; ?>">
    </div>
  ...
  <div class="row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" maxlength="11" name="customer['phone']" value="<?php echo $customer['phone']; ?>">
    </div>

    <div class="form-group col-md-2">
      <label for="campo3">Celular</label>
      <input type="text" class="form-control" maxlength="11" name="customer['mobile']" value="<?php echo $customer['mobile']; ?>">
    </div>

    <div class="form-group col-md-1">
      <label for="campo3">UF</label>
      <input type="text" class="form-control" maxlength="2" name="customer['state']" value="<?php echo $customer['state']; ?>">
    </div>
